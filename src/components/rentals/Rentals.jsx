      ...
      <div>
        ...
        <div onClick={this.togglei}>
          <i
            className={
              this.state.isAsc
                ? "fa fa-sort-asc fa-3x m-2"
                : "fa fa-sort-asc m-2 fa-3x show"
            }
          />
        </div>
        ...
        <div>
          <Button
            style={{ display: "block" }}
            onClick={() =>
              navigator.clipboard.writeText(this.state.textForClipborad)
            }
          >
            By clicking This Button the text was written in below text area will
            be copied in clipboard
          </Button>

          <textarea
            value={this.state.textForClipborad}
            onChange={(e) =>
              this.setState({ textForClipborad: e.target.value })
            }
          />
        </div>
      </div>
